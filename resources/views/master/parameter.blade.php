        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-bottom p-4">
                <h5 class="modal-title fw-bold text-primary" id="modalTitle">
                    <i class="bx bx-slider-alt me-2"></i>Create New Parameter
                </h5>
            ...
            <form id="parameterForm" action="{{ route('master.parameter.store') }}" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mt-3">
                        <label class="form-label fw-semibold text-danger">Max Threshold (Limit) <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text bg-danger-subtle text-danger border-danger border-end-0">
                        ...
                        <div class="form-text text-muted mt-2">
                            ...
                            Jika nilai sensor melebihi angka ini, sistem akan mengirim notifikasi <strong>EWS Alert</strong>.
                        </div>
                    </div>

                    <div class="mt-3">
                        <label class="form-label fw-semibold">Description</label>
                        <textarea class="form-control samu-input" name="description" id="description" rows="3" placeholder="Optional details about this parameter..."></textarea>
                    </div>
                </div>
...
<style>
    ...
    .samu-page-header {
        ...
        border-left: 5px solid var(--samu-danger); /* Merah untuk Parameter/Critical */
    ...
    /* Special Input for Threshold (Red Border) */
    .border-danger {
    ...
    $('#parameterTable').DataTable({
        ...
        columns: [
            ...
            { data: 'max_threshold', name: 'max_threshold', render: function(data) {
                ...
                return `<span class="fw-bold text-danger"><i class="bx bx-up-arrow-alt"></i> > ${val}</span>`;
            }},
