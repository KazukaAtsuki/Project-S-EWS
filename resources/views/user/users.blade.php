            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-1 fw-bold text-dark">User Management</h3>
                            <p class="text-muted mb-0">Manage system users, roles, and access</p>
                        </div>
                    </div>
                    <div>
                        <a href="{{ route('master.users.create') }}" class="btn samu-btn-primary px-4">
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table samu-table table-hover align-middle mb-0" id="usersTable" style="width:100%">
                        <thead>
                            <tr>
                                <th width="5%" class="text-center">No</th>
                                <th width="20%">User Details</th> <!-- Gabungan Name & Email -->
...
<style>
    ...
    /* Custom Avatar in Table */
    .table-avatar {
        width: 38px;
        height: 38px;
        background: linear-gradient(135deg, var(--samu-gold), var(--samu-blue));
        color: white;
        display: flex;
        align-items: center;
        justify-content: center;
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    // Render Name & Email in one column for cleaner look
            ...
            },
            {
                ...
                render: function(data) {
                    return `<span class="fw-semibold text-primary"><i class="bx bx-buildings me-1"></i>${data}</span>`;
                }
            },
            {
                data: 'role_badge',
            ...
            },
            {
                ...
                name: 'phone',
                render: function(data) {
                    return data ? `<span class="text-muted"><i class="bx bx-phone me-1"></i>${data}</span>` : '-';
                }
            },
            {
